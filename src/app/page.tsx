...
function HeroSection() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 md:px-8 pt-24">
      <div className="relative w-full max-w-4xl mx-auto">
        {/* Portrait Image */}
        <div className="relative w-64 md:w-80 h-80 md:h-[450px] mx-auto">
          <Image
          ...
          <div className="absolute inset-0 flex items-center justify-between pointer-events-none">
            <span className="mono-label text-gray-400 -rotate-90 origin-center absolute left-0 top-1/2 -translate-x-8 md:-translate-x-12">RADILSON GOMES</span>
            <span className="mono-label text-gray-400 rotate-90 origin-center absolute right-0 top-1/2 translate-x-8 md:translate-x-12">PRODUCT DESIGNER</span>
          </div>
        </div>

        {/* Location and status bar */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 mt-12 md:mt-16 text-sm">
          <div className="flex items-center gap-4">
            <span className="text-white">Based in Brasilia, Brazil</span>
            <span className="mono-label text-gray-500">{time} UTC</span>
            <span className="mono-label text-gray-500">{temp}°C</span>
          </div>

          <Link href="#intro" className="flex items-center gap-2 hover:text-white transition-colors">
            <span className="mono-label text-gray-500">SCROLL</span>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="text-gray-500 animate-bounce">
              <path d="M12 5v14M5 12l7 7 7-7" strokeWidth="2"/>
            </svg>
          </Link>

          <div className="flex items-center gap-2">
            <span className="mono-label text-gray-500 hidden md:inline">Freelance Availability</span>
